...
<link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
 ...
 <body>
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="http://localhost/testAngularJs/LoginUtilisateur/index.php#">Utilisateur</a></li>
            <li class="divider"></li>
  ...
  <div ng-app="login_register_app" ng-controller="login_register_controller" class="container form_style">
   ...
   <div class="panel  panel-transparent">
    <div class="panel-heading">
     <!--<h3 class="panel-title">Welcome to BeePhyto</h3>-->
    </div>
    <div class="panel-body">
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <a href="http://localhost/testAngularJs/homeClient.html" class="btn"><font color="#fff">Next &raquo;</font></a>
    </div>
   </div>
   <?php
   }
